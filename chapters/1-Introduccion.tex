...
El capítulo de ~\nameref{cap:experimentos} detalla cómo se evaluó la solución y el por qué se decidió una topología en particular y su nivel de replicación de operadores.\\
