...
El capítulo ~\nameref{cap:Construccion} detalla los aspectos de toma de requerimientos y diseño de la aplicación detallando las desiciones que se tomaron para solucionar los problemas encontrados en el desarrollo del la aplicación.\\